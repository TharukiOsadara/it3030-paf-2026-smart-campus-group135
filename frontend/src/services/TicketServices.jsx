// ticketService.js
// All API interactions for Module C – Incident Tickets & Attachments
...
export const ticketService = {
  ...
  // ── POST: Create a new ticket (multipart/form-data with attachments)
  createTicket: async (formData) => {
    const res = await fetch(`${BASE}/tickets`, {
      method: "POST",
      headers: headers(true), // No Content-Type, let browser set multipart boundary
      body: formData,
    });
    return handleResponse(res);
  },
