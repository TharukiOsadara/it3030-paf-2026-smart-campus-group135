...
export default function BookingForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    try {
      // Using userId=2 as a default logged-in user (John Doe from seed data)
      const payload = {
      ...
      >
        ...
        <div className="mt-8 flex justify-end">
          <button
            type="submit"
            disabled={loading}
            className="rounded-xl bg-[#3B82F6] px-8 py-3 text-sm font-semibold text-white shadow-lg shadow-[#3B82F6]/25 transition-all hover:bg-[#2563EB] hover:shadow-[#3B82F6]/40 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#3B82F6] disabled:cursor-not-allowed disabled:opacity-50"
          >
